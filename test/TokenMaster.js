...
const OCCASION_NAME = "ETH Texas Hackathon";
const OCCASION_COST = ethers.utils.parseUnits("1", "ether");
const OCCASION_MAX_TICKETS = 100;
const OCCASION_DATE = "Mar 17";
const OCCASION_TIME = "10:00AM IST";
const OCCASION_LOCATION = "Dwarka, Delhi";
...
describe(NAME, () => {
  ...
  describe("Occasion", () => {
    it("Increment occasions count", async () => {
      const totalOccasions = await tokenMaster.totalOccasions();
      expect(totalOccasions).to.be.equal(1);
    });

    it("Checks Occasion Information", async () => {
  ...
  describe("Minting", () => {
    ...
    it("Decrement tickets count", async () => {
      const occasion = await tokenMaster.getOccasion(1);
    ...
    it("Overall seating status", async () => {
